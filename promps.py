...
class DiscretePROMP(object):
    """
    For more details on the implementation, refer : https://link.springer.com/article/10.1007/s10514-017-9648-7
    """
    ...
    def generate_trajectory(self, phase_speed=1., randomness=1e-4):
        ...
        # xs = np.linspace(0,1,len(new_mean_W)).tolist()

        # sigmas = new_sigma_W.tolist()
        # # print new_sigma_W.shape
        # # print sigmas

        # ys = new_mean_W.tolist()
